...
//        dictDevice.setValue(Constant.appVersion, forKey: "appVersion")
...
//            return
//        }
//        let loginViewController = UIStoryboard.loadInitialViewController() as LanguageVC
...
struct valid {
    static let enterGpTitle = "Enter the group name"
    static let enterGpDescription = "Enter the group description "
    
    static let enterTitle = "Enter your title"
    static let enterDesc = "Please enter the reason you are reporting this comment."
    static let selectVideo = "Select a video"
    static let enterDisplayName = "Enter your display name"
    static let selectprofileImage = "Select your profile image"
    
    static let selectState = "Select your state"
    static let selectGarde = "Select your grade"
    static let selectTeacherGarde = "Select your grade(s)"

        static let selectaGarde = "Select a grade"
    static let selectleastTeacher = "Select at least one teacher"
    static let selectleastGrade = "Select at least one grade"
    
    
    static let selectDistrict = "Select your district"
    static let selectEnterDistrict = "Select your district"
    static let selectSchool = "Select your school"
    static let selectTeacher = "Select your teacher"
    
    static let enterEmail = "Enter your email address"
    static let enterFullName = "Enter child's full name"
    
    static let enterFirstName = "Enter your first name"
    static let enterLastName = "Enter your last name"
    static let enterOTP = "Enter verification code"
    static let enterSchoolName = "Enter your school name"
    static let enterDistrict = "Enter your district"
    static let enterStateFirst = "Select your state"
    static let enterstate = "Select your state"
    static let validEmail = "Enter a valid email address"
    static let validIndex = "Enter index"
    static let validRating = "Please provide rating"

    static let validpassword = "Must contain minimum of 6 characters with at least 1 Alphabet, 1 Number and 1 Special Character"
    static let enternumber = "Enter your phone number"
    static let validEnterNumber = "Enter a valid phone number"
    static let golfCourse = "Enter course"

    static let passwordNotMatch = "New password and confirmation password doesn’t match"
    static let temsConditions = "Agree to the Terms of Services and Privacy Policy"
    
    static let sendTo = "Select the recipients"
    static let subject = "Enter your subject"
    static let message = "Enter your message"
    static let currentPassword = "Enter your current password"
    static let passwordNoSsame = "Current password and old password can not be same"
    //Current and new password can't be the same
    static let newpassword = "Enter a new password"
    static let name = "Enter your name"
    static let username = "Enter your user name"

    static let selectReasonType = "Select a reason"
    static let enterAskQuestion = "What information can we provide you?"
    
    static let password = "Create a password"
    static let confirmPassword = "Confirm your password"
    
    static let confirmReEnterPassword = "Re-enter your new password"
    static let validLocation = "Enter your Location"

    static let loginPassword = "Enter your password"
    static let resetCode = "Enter the reset code"
    
    static let enterVideoTitle = "Enter your video's title"
    static let enterVideoDescription = "Enter your video's description "
    
    static let selectaSchool = "Select a school"
    static let selectaTeacher = "Select a teacher"
    static let selectagrade = "Select a grade"
    static let selectaSubject = "Select a subject"
}
